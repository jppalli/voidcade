...
/**
 * "Oops" cat — same lavender face but with X eyes, tongue out, little stars,
 * and a slight tilt. Funny, not creepy. Used for wrong-guess cells.
 */
export function deadCatSvg(size = 100): string {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="${size}" height="${size}" aria-hidden="true">
  <!-- slight tilt for comedic effect -->
  <g transform="rotate(-12, 50, 57)">
    ...
    <path d="M30.5 36 L32.5 18 L46 27 Z" fill="#ded8f0"/>
    <path d="M69.5 36 L67.5 18 L54 27 Z" fill="#ded8f0"/>
    <ellipse cx="33" cy="62" rx="5.5" ry="3.4" fill="#e7908c" opacity="0.65"/>
    <ellipse cx="67" cy="62" rx="5.5" ry="3.4" fill="#e7908c" opacity="0.65"/>
    <!-- whiskers -->
    <g fill="none" stroke="#fff8ef" stroke-width="2.6" stroke-linecap="round">
      <line x1="22" y1="60" x2="6"  y2="57"/>
      <line x1="22" y1="67" x2="7"  y2="69"/>
      <line x1="78" y1="60" x2="94" y2="57"/>
      <line x1="78" y1="67" x2="93" y2="69"/>
    ...
    <!-- X eyes -->
    <g fill="none" stroke="#fff8ef" stroke-width="3.6" stroke-linecap="round">
    ...
    <!-- tongue out -->
    <ellipse cx="50" cy="72" rx="5.5" ry="4" fill="#ff9aaa"/>
    <path d="M44.5 69 Q50 74 55.5 69" fill="#ff9aaa" stroke="none"/>
    <!-- little impact stars -->
    <g fill="none" stroke="#fff8ef" stroke-width="2.2" stroke-linecap="round">
